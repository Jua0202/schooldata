    ...
    public void signup(){
        ...
        try{
            ...
            if(su_username.getText().isEmpty()
                ...
                alert1.setTitle("test");
                alert1.setHeaderText(null);
                alert1.setContentText("test");
                alert1.showAndWait();
                if(validationEmail()){

                    String uri = "C:\\Users\\najwa\\Downloads\\School-Management-System-project2-main\\School-Management-System-project2-main\\Project5_SchoolManagement\\src\\project5_schoolmanagement\\logo.jpg";
